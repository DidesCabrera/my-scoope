...
from notas.interface.views.proposals import (
    ...
    proposal_program_detail,
    proposal_program_food_detail,
    proposal_program_meal_detail,
    proposal_reject,
...
urlpatterns = [
    ...
    path("proposals/<int:proposal_id>/program/", proposal_program_detail, name="proposal_program_detail"),
    path("proposals/<int:proposal_id>/program/weeks/<int:week_number>/days/<int:day_number>/", proposal_program_dailyplan_detail, name="proposal_program_dailyplan_detail"),
    path("proposals/<int:proposal_id>/program/weeks/<int:week_number>/days/<int:day_number>/meals/<int:meal_number>/", proposal_program_meal_detail, name="proposal_program_meal_detail"),
    path("proposals/<int:proposal_id>/program/weeks/<int:week_number>/days/<int:day_number>/meals/<int:meal_number>/foods/<int:food_number>/", proposal_program_food_detail, name="proposal_program_food_detail"),
