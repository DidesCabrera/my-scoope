    ...
    NavSectionSpec(
        ...
        groups=(
            ...
            NavGroupSpec(
                ...
                items=(
                    NavItemSpec(
                        key="comparator_foods",
                        label="Comparar Alimentos",
                        icon="carrot",
                        page_icon="scale",
                        url_name="food_comparator",
                        nav_root="comparator",
                        scope="foods",
                    ),
                    NavItemSpec(
                        key="comparator_meals",
                        label="Comparar Comidas",
                        icon="utensils",
                        page_icon="scale",
                        url_name="meal_comparator",
                        nav_root="comparator",
                        scope="meals",
                    ),
                    NavItemSpec(
                        key="comparator_dailyplans",
                        label="Comparar Planes",
                        icon="clipboard-list",
                        page_icon="scale",
                        url_name="dailyplan_comparator",
                        nav_root="comparator",
                        scope="dailyplans",
                    ),
                ),
            ...
            NavGroupSpec(
                ...
                items=(
                    ...
                    NavItemSpec(
                        ...
                        icon="wrench",
                        page_icon="wrench",
                        url_name="admin_operations_overview",
                        nav_root="admin_operations",
                        scope="overview",
                        show_in_sidebar=True,
                    ),
                    NavItemSpec(
                        ...
                        icon="library-big",
                        page_icon="library-big",
                        url_name="admin_knowledge_overview",
                        nav_root="admin_knowledge",
                        scope="overview",
                        show_in_sidebar=True,
                    ),
                    NavItemSpec(
