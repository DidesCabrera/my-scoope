...
const styles = StyleSheet.create({
  ...
  nutritionSummaryRow: { alignItems: "center", flexDirection: "row", flexWrap: "wrap", gap: 10, paddingBottom: tokens.spacing.sm, paddingHorizontal: tokens.spacing.md, paddingTop: tokens.spacing.sm },
  nutritionSummaryItem: { alignItems: "center", flexDirection: "row", gap: 5 },
  nutritionSummaryDot: { borderRadius: 4, height: 8, width: 8 },
  nutritionSummaryValue: { color: tokens.color.textMuted, fontSize: tokens.type.label, fontVariant: ["tabular-nums"], fontWeight: tokens.weight.medium, letterSpacing: 0 },
