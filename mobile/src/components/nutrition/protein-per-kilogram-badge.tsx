...
export function ProteinPerKilogramBadge({
  ...
  return (
    <View
      accessibilityLabel={`Proteina por kilogramo: ${formattedValue(value)} gramos por kilogramo`}
      accessible
      style={[styles.badge, compact && styles.badgeCompact]}>
      <Text numberOfLines={1} style={[styles.text, { fontSize: textSize }]}>
...
const styles = StyleSheet.create({
  ...
  text: { color: "#111111", fontSize: tokens.type.caption, fontWeight: "500", fontVariant: ["tabular-nums"], letterSpacing: 0 },
});
