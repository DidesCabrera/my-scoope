...
export type DailyPlanShareSnapshot = {
  schema_version: string;
  subject: { type: "daily_plan"; title: string };
  summary: { meal_count: number; food_count: number };
...
export type ShareResource = {
  ...
  created_at?: string;
  snapshot?: DailyPlanShareSnapshot;
};
...
export type LibraryItem = {
  ...
  label_capture_receipt_id?: number | null;
  label_image_available?: boolean;
};
