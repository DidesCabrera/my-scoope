...
const styles = StyleSheet.create({
  ...
  builderTabs: { backgroundColor: tokens.color.surfaceApp, borderBottomColor: tokens.color.borderSoft, borderBottomWidth: 1, marginHorizontal: -tokens.spacing.screen, paddingBottom: tokens.spacing.sm, paddingHorizontal: tokens.spacing.screen, paddingTop: tokens.spacing.xs },
  dashboardStickyHeader: { marginHorizontal: -tokens.spacing.screen, paddingTop: tokens.spacing.sm },
