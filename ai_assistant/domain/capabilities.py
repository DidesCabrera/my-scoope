...
CAPABILITIES = (
    ...
    AssistantCapability("foods.manage", "foods", "Crear, actualizar o eliminar alimentos propios.", AssistantCapabilityMode.PREPARED_ACTION, ("propose_workspace_patch",), ("food.create", "food.update", "food.delete")),
    ...
    AssistantCapability("meals.manage", "meals", "Crear, renombrar o eliminar comidas propias.", AssistantCapabilityMode.PREPARED_ACTION, ("propose_workspace_patch",), ("meal.create", "meal.rename", "meal.delete")),
    AssistantCapability("meals.compose", "meals", "Agregar, cambiar o quitar alimentos y cantidades de comidas propias.", AssistantCapabilityMode.PREPARED_ACTION, ("propose_workspace_patch",), ("meal.add_food", "meal.update_food", "meal.remove_food")),
    AssistantCapability("meals.copy_save_share", "meals", "Copiar, guardar o compartir comidas.", AssistantCapabilityMode.TRUSTED_UI_HANDOFF),
    ...
    AssistantCapability("dailyplans.manage", "dailyplans", "Crear, renombrar o eliminar planes propios.", AssistantCapabilityMode.PREPARED_ACTION, ("propose_workspace_patch",), ("dailyplan.create", "dailyplan.rename", "dailyplan.delete")),
    AssistantCapability("dailyplans.compose", "dailyplans", "Agregar, cambiar o quitar comidas snapshot de planes propios.", AssistantCapabilityMode.PREPARED_ACTION, ("propose_workspace_patch",), ("dailyplan.add_meal", "dailyplan.update_meal", "dailyplan.remove_meal")),
    AssistantCapability("dailyplans.copy_save_share", "dailyplans", "Copiar, guardar o compartir planes.", AssistantCapabilityMode.TRUSTED_UI_HANDOFF),
    ...
    AssistantCapability("programs.manage", "programs", "Crear, renombrar, eliminar o gestionar semanas.", AssistantCapabilityMode.PREPARED_ACTION, ("propose_workspace_patch",), ("program.create", "program.rename", "program.delete", "program.add_week", "program.duplicate_week", "program.remove_week")),
    ...
    AssistantCapability("calendar.lifecycle", "calendar", "Pausar, reanudar o cancelar una calendarización.", AssistantCapabilityMode.PREPARED_ACTION, ("propose_workspace_patch",), ("calendar.pause", "calendar.resume", "calendar.cancel")),
    ...
    AssistantCapability("comparisons.manage", "comparisons", "Renombrar comparaciones guardadas.", AssistantCapabilityMode.PREPARED_ACTION, ("propose_workspace_patch",), ("comparison.rename",)),
    ...
    AssistantCapability("proposals.lifecycle", "proposals", "Aprobar, rechazar, cancelar, eliminar o aplicar propuestas.", AssistantCapabilityMode.PREPARED_ACTION, ("propose_workspace_patch",), ("proposal.approve", "proposal.reject", "proposal.cancel", "proposal.delete", "proposal.apply")),
