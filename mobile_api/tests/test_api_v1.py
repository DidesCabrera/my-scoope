...
class MobileAPIV1Tests(AuthenticatedMobileAPITestCase):
    def test_health_and_openapi_contract_are_public_and_versioned(self):
        ...
        for path in (
            ...
            "/api/v1/program/days/{day_id}/meal-picker/preview",
            "/api/v1/program/days/{day_id}/meal-picker/commit",
            "/api/v1/program/days/{day_id}/meals/{meal_snapshot_key}/food-picker/preview",
            "/api/v1/program/days/{day_id}/meals/{meal_snapshot_key}/food-picker/commit",
            "/api/v1/proposals",
