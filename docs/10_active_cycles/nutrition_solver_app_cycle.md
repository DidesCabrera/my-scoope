...
- S1: iniciado y documentado. El primer patch no mueve código; crea el mapa de extracción vigente en `docs/00_current/architecture/nutrition_solver_extraction_map.md` y registra la decisión en `docs/20_decisions/0044-nutrition-solver-extraction-start.md`.
