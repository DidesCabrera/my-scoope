...
docs/00_current/design/ui_system.md
docs/00_current/architecture/ui_patterns.md
docs/10_active_cycles/product_intelligence_admin_analytics_cycle.md
docs/20_decisions/*admin-analytics*
