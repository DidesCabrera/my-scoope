...
2. Leer `docs/00_current/architecture/layers.md`.
3. Leer `docs/00_current/architecture/rules.md`.
4. Leer `docs/00_current/architecture/section_creation_guide.md`.
