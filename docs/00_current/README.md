...
14. `../20_decisions/0020-ai-assistant-django-app-and-chat-engine.md`
15. `../20_decisions/0028-ai-assistant-activation-cycle.md`
16. `features/ai_nutrition_onboarding/ai_nutrition_onboarding.md`
17. `../20_decisions/0050-onboarding-nutrition-profile-and-subject-context.md` cuando el trabajo toque onboarding nutricional, ficha personal, sujeto de cálculo o PPK en propuestas externas.
18. `../10_active_cycles/onboarding_nutrition_profile_cycle.md` para historia y alcance cerrado del ciclo ONB00-ONB09.
19. `../40_technical/qa/onboarding_nutrition_v1_qa.md` cuando se modifique onboarding, ficha nutricional, subject context, solver o warning de propuestas externas.
20. `architecture/nutrition_solver_extraction_map.md` cuando el trabajo sea Nutrition Solver.
21. `features/admin_knowledge/README.md` como Knowledge Center para operación conjunta de Food
