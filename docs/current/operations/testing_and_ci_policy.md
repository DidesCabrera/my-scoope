...
They should not depend on `docs/archive/` unless the test explicitly validates
...
[ ] docs/current or docs/decisions were updated when the patch changed a stable contract.
