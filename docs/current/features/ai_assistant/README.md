...
notas/application/ai_intake/chat_engine.py
  # adapter del flujo determinístico actual al contrato ChatEngine
```
...
Ver `docs/decisions/0028-ai-assistant-activation-cycle.md` y `docs/decisions/0035-ai-assistant-usage-observability-and-credits.md`.
...
Ver `docs/decisions/0035-ai-assistant-usage-observability-and-credits.md`.
...
- `docs/decisions/0035-ai-assistant-usage-observability-and-credits.md`
- `docs/decisions/0036-ai-assistant-usage-observability-implementation.md`
- `docs/decisions/0008-ai-assisted-onboarding-to-first-plan.md`
- `docs/decisions/0010-mcp-operational-food-boundary.md`
- `docs/decisions/0016-mcp-food-boundary-hardening.md`
...
Patch 58 consolida el modo `llm_preview` sobre la UI existente de AI Nutrition Intake. El preview usa `assistant.ai_nutrition_intake.preview` como `action_type`, pasa metadata segura de conversación/turno al recorder, muestra estado del motor activo en el chat y conserva fallback determinístico. Ver `docs/decisions/0038-ai-assistant-chat-preview-with-guardrails.md`.
...
- [0042 · AI Assistant gradual production rollout](../../../decisions/0042-ai-assistant-gradual-production-rollout.md)
