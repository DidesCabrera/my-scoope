...
Hasta ahora `docs/current/` contenía documentación vigente y `docs/decisions/` registraba decisiones aceptadas. Faltaba un lugar oficial para planes futuros que una IA pudiera leer sin confundirlos con contratos ya implementados.
...
Esta carpeta contiene planes de ciclos futuros con estado explícito. No reemplaza `docs/current/` ni `docs/decisions/`.
...
- Las decisiones estables que nazcan desde un plan deben seguir registrándose en `docs/decisions/`.
