...
ADR [0001](0001-layer-boundaries.md) and `docs/current/architecture/rules.md` define a
...
`docs/current/architecture/rules.md` keep applying here without change, and
...
- `docs/current/architecture/rules.md` gets a section distinguishing intentional
