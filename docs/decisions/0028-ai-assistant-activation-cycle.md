...
Ver `docs/decisions/0029-ai-assistant-provider-diagnostics.md`.
...
Ver `docs/decisions/0030-ai-assistant-chat-engine-selector.md`.
...
Ver `docs/decisions/0031-ai-assistant-safe-llm-context-builder.md`.
...
Ver `docs/decisions/0033-ai-assistant-llm-read-only-tool-loop.md`.
...
Ver `docs/decisions/0034-ai-assistant-reviewable-proposal-tool-executor.md`.
...
Ver también `docs/decisions/0035-ai-assistant-usage-observability-and-credits.md`.
