...
SHARING_RESOURCE_TTL_DAYS = _env_int("SHARING_RESOURCE_TTL_DAYS", 30)
SHARING_RESOURCE_RETENTION_DAYS = _env_int("SHARING_RESOURCE_RETENTION_DAYS", 30)
MYSCOOPE_APPLE_TEAM_ID = os.environ.get("MYSCOOPE_APPLE_TEAM_ID", "").strip()
MYSCOOPE_ANDROID_SHA256_CERT_FINGERPRINTS = _env_csv(
...
NUTRITION_SOLVER_ALTERNATIVE_COUNT = max(
    1,
...
BILLING_GOOGLE_PLAY_SERVICE_ACCOUNT_JSON = _env_json_object("BILLING_GOOGLE_PLAY_SERVICE_ACCOUNT_JSON")
